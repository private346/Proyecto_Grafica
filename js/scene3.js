...
/*fontLoader.load(
    ...
    function (font) {
        ...
        const textGeometry = new TextGeometry('REVOLUCION \n         3D', {
            font: font,
            size: 1,
            height: 0.3
        });
...
crearModelo3D(
    "games",
    "./models/game_for_nintendo64.glb",
    0.005,
    0.5
);
// ======================================
