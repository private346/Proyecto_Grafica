...
/*fontLoader.load(
    ...
    function (font) {
        ...
        const textGeometry = new TextGeometry('LOS ORIGENES DEL \n     VIDEOJUEGO', {
            font: font,
            size: 0.7,
            height: 0.3
        });
...
const posterTexture4 = textureLoader.load(
    './models/textures/computerspace.jpg'
);
